  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
          ...
          MultiProvider(
            providers: [
              Provider<DummyProvider>(create: (context) => DummyProvider(5),),
              ProxyProvider<DummyProvider,SquareNum>(create: (context) => SquareNum(0), update: (context, DummyProvider dummyProvider, previous) {
